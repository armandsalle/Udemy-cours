...
var budgetController = (function() {
  ...
  return {
    addItem: function(type, des, val) {
      var newItem, ID;
      //create new id based on the data lenght +1
      ...
      //create nesw item based on inc or exp type
      if (type === "exp") {
    ...
    calculateBudget: function() {
      ...
      //calculate the percentage of exp
...
var controller = (function(budgetCtrl, uiCtrl) {
  ...
  var ctrlAddItem = function() {
    ...
    if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
      ...
      // 4. calculate and update budget and percentages
      updateBudget();
      updatePercentages();
    }
  };
